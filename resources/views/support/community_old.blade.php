...
@section('content')
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <a href="{{ env('SOCIAL_GITHUB') }}" target="_blank" class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 group hover:-translate-y-1">
                ...
                <p class="text-gray-600">Code source ouvert, issues et discussions techniques</p>
            </a>

            <a href="{{ env('SOCIAL_TWITTER') }}" target="_blank" class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 group hover:-translate-y-1">
                <div class="w-12 h-12 bg-blue-400 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-300 transition-colors">
                    <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                </div>
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Twitter/X</h3>
                <p class="text-gray-600">Actualités et échanges avec la communauté</p>
            </a>

            <a href="{{ env('SOCIAL_LINKEDIN') }}" target="_blank" class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 group hover:-translate-y-1">
                ...
                <p class="text-gray-600">Réseau professionnel et annonces business</p>
            </a>

            <a href="{{ env('SOCIAL_FACEBOOK') }}" target="_blank" class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 group hover:-translate-y-1">
                <div class="w-12 h-12 bg-blue-500 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-400 transition-colors">
                    <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                </div>
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Facebook</h3>
                <p class="text-gray-600">Communauté et actualités</p>
            </a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-16">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ env('SOCIAL_GITHUB') }}/discussions" target="_blank" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-16">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Où nous trouver</h2>
            <p class="text-gray-600 mb-8">Notre communauté est active sur plusieurs plateformes. Rejoignez-nous là où vous vous sentez le plus à l'aise :</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div>
                    ...
                    <ul class="space-y-3 text-gray-600">
                        <li class="flex items-start">
                            ...
                            Discussions techniques et suggestions d'améliorations
                        </li>
                        <li class="flex items-start">
                            <span class="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                        ...
                        <li class="flex items-start">
                            <span class="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                            Code source ouvert et contributions bienvenues
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-600">
                        <li class="flex items-start">
                            <span class="w-1.5 h-1.5 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                            Twitter/X : Actualités et échanges rapides
                        </li>
                        <li class="flex items-start">
                        ...
                        <li class="flex items-start">
                            ...
                            Facebook : Communauté et discussions
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-200 p-8 text-center">
            ...
            <div class="bg-white rounded-xl p-6 mb-6">
                <h3 class="font-semibold text-gray-900 mb-3">Comment contribuer</h3>
                <ul class="text-gray-600 space-y-2">
                    <li>• Fork le repository et proposez vos améliorations</li>
                    <li>• Signalez des bugs ou suggérez des fonctionnalités</li>
                    <li>• Aidez à améliorer la documentation</li>
                    <li>• Partagez vos retours d'expérience</li>
                </ul>
            </div>
            
            <a href="{{ env('SOCIAL_GITHUB') }}" target="_blank" class="inline-flex items-center px-6 py-3 bg-gray-800 text-white font-medium rounded-xl hover:bg-gray-700 transition-colors shadow-md hover:shadow-lg">
