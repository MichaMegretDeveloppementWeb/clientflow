    ...
    <div class="mx-auto max-w-[100em] px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="https://x.com/stone_app" target="_blank" rel="noopener" class="flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-blue-100 transition-colors group">
                        ...
                        <a href="https://facebook.com/stone.app" target="_blank" rel="noopener" class="flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-blue-100 transition-colors group">
                            <svg class="h-5 w-5 text-gray-600 group-hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="https://instagram.com/stone_app" target="_blank" rel="noopener" class="flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-pink-100 transition-colors group">
                        ...
                        <a href="https://linkedin.com/company/stone-app" target="_blank" rel="noopener" class="flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-blue-100 transition-colors group">
                        ...
                        <a href="https://github.com/stone-app/stone" target="_blank" rel="noopener" class="flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors group">
                ...
                <div class="flex items-center space-x-4">
                    <a href="mailto:contact@stone.com" class="flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors">
                        <x-heroicon-o-envelope class="h-5 w-5 text-gray-600" />
                    </a>
                    <a href="tel:+33123456789" class="flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors">
        ...
        <div class="border-t border-gray-100 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-600 text-sm">
                © 2025 Stone. Conçu avec ❤️ à Evian-les-bains, pour les freelances.
            </p>
